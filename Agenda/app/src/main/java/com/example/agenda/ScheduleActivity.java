...
import com.example.agenda.adapter.SchedulePagerAdapter;
...
public class ScheduleActivity extends AppCompatActivity {
    ...
    private ConstraintLayout cl_schedule; // 声明一个日程表区域的线性视图对象
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cl_schedule = findViewById(R.id.cl_schedule);
    ...
    protected void onResume() {
        ...
        if (mFestivalResid != 0) { // 在横屏和竖屏之间翻转时，不会重新onCreate，只会onResume
            cl_schedule.setBackgroundResource(mFestivalResid);
        }
    }
